...
\Step{
  ...
  \begin{scope}[local to=Canvas]
    \node[opacity=.2] (github) at (0, .5)
      {\includegraphics[width=75mm]{github_logo.png}};
    \foreach \xy/\file in {{-.7,-.6}/my_machine,
                           { .7,-.6}/their_machine}{%
      \node[opacity=.2] (github) at (\xy)
        {\includegraphics[width=75mm]{\file.png}};
    }
  \end{scope}
  ...
  \LocalRepoLabel{base west}{mine.west}{my machine}
  \Branch[Blue4]{58d8fe0}{25:20}{-.5,0}{main}
  \Head{58d8fe0}{155:20}{.5,0}
...
\Step{
  ...
  \RemoteRepoLabel{fork}{TheirAccount}
  \Branch[Blue4]{58d8fe0}{25:20}{-.5,0}{main}
  \Head{58d8fe0}{155:20}{.5,0}
  ...
  \node[below=5 of command, draw=Blue4, line width=7]{\includegraphics[height=15mm]{sync_fork_button.png}};
