...
\IntensiveCoordinates{Screen}{c}{-.99, -.99}
\node[anchor=south west] (cesab) at (c) {\PicFRBCESAB{!}{7cm}};
\IntensiveCoordinates{Screen}{c}{+.97, 0}
\node[anchor=east] (isem) at (cesab -| c) {\PicISEM{!}{3cm}};

\IntensiveCoordinates{Screen}{c}{-.95, +.97}
\node[anchor=north west] (form) at (c) {\PicFormation{5cm}{!}};
