...
\Step{
  ...
  \Diff[0][north east][A]{$(A.south east) + (0, -\DiffFilesSpacing)$}{other.ext}{
    -/{Another line.},
  }
  ...
  \Branch[base][label]{hash256}{40:20}{-.5,0}{main}
  \Head[base east][label]{main.base west}{15}{2}
  \RemoteBranch[base west][label]{main.base east}{1}{noarrow}{github/main}
...
\Step{
  ...
  \RemoteArrow[github][0][left]{mine.north}{remote.south west}
  \RemoteArrow[origin][0][left]{theirs.north}{remote.south east}

  \RemoteArrow[][40][left]{-.8, -.1}{-.2, .6}
