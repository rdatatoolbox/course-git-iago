...
% SLIDE Staging
\renewcommand{\TitleText}{Recording a Commit}
...
\Repo[south west][repo][simple][1]{-1, -.76}{}{}
...
\FileTree[base west][unit-tree]{c}{file/0/filenode/filename.ext}
...
\tikzmath{
  \CommitSpacing = \CommitSpacingSafe;
}
\Step{4/5}{
