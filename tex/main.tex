...
\Step{
  ...
  \Repo[south west][repo][simple]{Canvas.south west}{
  }
...
\Step{
  ...
  \AutomaticCoordinates{A}{.7, 1}
  \FirstFile[folder, mod=0]{A}{A}{root}

  \AutomaticCoordinates{C}{1, .85}
  ...
  \begin{scope}[local to=Canvas]\begin{pgfonlayer}{background}
    ...
    \node[opacity=.2] (theirmachine) at (+.7, -.6) {\PicTheirMachine{75mm}{!}};
  ...
  \Repo[base][remote][double]{.1, .08}{
  }


  \Repo[base][theirs][double]{.55, -1}{
  }
